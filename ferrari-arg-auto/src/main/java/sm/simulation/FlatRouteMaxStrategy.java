 ...
 * @author sm
 */
public final class FlatRouteMaxStrategy implements VehiclesGenerationStrategy {
    ...
    public List<CrossingCar> newCars() {
        if (this.setup) {
            ...
            final UrgentCar car = new UrgentCar(new Car(
                    String.format("%s_%d_%s", way, this.nCars, this.getJunction().getId()).replace("ways ", "W"),
